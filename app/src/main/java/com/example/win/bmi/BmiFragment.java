...
public class BmiFragment extends Fragment {
    ...
    private void setListeners() {
        if (bmi_system.getSystem() == 0) {
            ...
            weightTxt.setText(getString(R.string.weight_flb));
        }
    ...
    private void setAdviceColor(int advice){
        ...
        if(advice==2){
            advices[0].setBackgroundColor(ContextCompat.getColor(getContext(),R.color.colorPrimary));
            advices[1].setBackgroundColor(ContextCompat.getColor(getContext(),R.color.colorPrimary));
            advices[0].setTextColor(Color.parseColor("#ffffff"));
            advices[1].setTextColor(Color.parseColor("#ffffff"));
        }else if(advice==0){
            advices[2].setBackgroundColor(ContextCompat.getColor(getContext(),R.color.colorPrimary));
            advices[3].setBackgroundColor(ContextCompat.getColor(getContext(),R.color.colorPrimary));
            advices[2].setTextColor(Color.parseColor("#ffffff"));
            advices[3].setTextColor(Color.parseColor("#ffffff"));
        }else if(advice==1){
            advices[4].setBackgroundColor(ContextCompat.getColor(getContext(),R.color.colorPrimary));
            advices[5].setBackgroundColor(ContextCompat.getColor(getContext(),R.color.colorPrimary));
